...
#include "../online/m_spdz_mpir_512.h"
#include "../mpir/mpir.h"
...
int main(int argc, char **argv)
{
	...
	fin1.open("/home/jackie/spdz/pre_data/predata_mspdz/512/input_x.txt", std::ios::in);
	fin2.open("/home/jackie/spdz/pre_data/predata_mspdz/512/input_y.txt", std::ios::in);
	fin3.open("/home/jackie/spdz/pre_data/predata_mspdz/512/mac_x.txt", std::ios::in);
	fin4.open("/home/jackie/spdz/pre_data/predata_mspdz/512/mac_y.txt", std::ios::in);
	...
	std::cout << "MATRIX MUL: " << sum_time / 10
			  << " ns" << std::endl;
